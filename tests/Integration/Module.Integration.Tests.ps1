...
AfterAll {
    # Clean up
    Remove-Module 'PSBuienradar' -ErrorAction SilentlyContinue
}

Describe 'PSBuienradar Integration Tests' -Tag 'Integration' {

    Context 'Module Loading' {
        It 'Should load the module successfully' {
            $module = Get-Module -Name 'PSBuienradar'
        ...
        It 'Should have correct module name' {
            $module = Get-Module -Name 'PSBuienradar'
            $module.Name | Should -Be 'PSBuienradar'
        }
